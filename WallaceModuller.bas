...
Select Case Sýra
Case 0
aLLID = Strings.mID(AlignDWORD(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + 0) + PartyID) + 0), 1, 4)
Case 1
aLLID = Strings.mID(AlignDWORD(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + 0)) + PartyID) + 0), 1, 4)
Case 2
aLLID = Strings.mID(AlignDWORD(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + 0))) + PartyID) + 0), 1, 4)
Case 3
aLLID = Strings.mID(AlignDWORD(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + 0)))) + PartyID) + 0), 1, 4)
Case 4
aLLID = Strings.mID(AlignDWORD(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + 0))))) + PartyID) + 0), 1, 4)
Case 5
aLLID = Strings.mID(AlignDWORD(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + 0)))))) + PartyID) + 0), 1, 4)
Case 6
aLLID = Strings.mID(AlignDWORD(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + 0))))))) + PartyID) + 0), 1, 4)
Case 7
aLLID = Strings.mID(AlignDWORD(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + 0)))))))) + PartyID) + 0), 1, 4)
End Select
End Function
Function aLLNick(Sýra As Integer) As String
Select Case Sýra
Case 0
aLLNick = ReadString(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + PartyAdý) + &H0, ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + PartyAdý))
Case 1
aLLNick = ReadString(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + PartyAdý) + &H0, ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + PartyAdý))
Case 2
aLLNick = ReadString(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + &H0) + PartyAdý) + &H0, ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + &H0) + PartyAdý))
Case 3
aLLNick = ReadString(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + &H0) + &H0) + PartyAdý) + &H0, ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + &H0) + &H0) + PartyAdý))
Case 4
aLLNick = ReadString(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + &H0) + &H0) + &H0) + PartyAdý) + &H0, ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + &H0) + &H0) + &H0) + PartyAdý))
Case 5
aLLNick = ReadString(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + &H0) + &H0) + &H0) + &H0) + PartyAdý) + &H0, ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + &H0) + &H0) + &H0) + &H0) + PartyAdý))
Case 6
aLLNick = ReadString(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + &H0) + &H0) + &H0) + &H0) + &H0) + PartyAdý) + &H0, ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + &H0) + &H0) + &H0) + &H0) + &H0) + PartyAdý))
Case 7
aLLNick = ReadString(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + &H0) + &H0) + &H0) + &H0) + &H0) + &H0) + PartyAdý) + &H0, ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(ReadLong(KO_OFF_PARTY) + PartyOffset) + PartyValue) + &H0) + &H0) + &H0) + &H0) + &H0) + &H0) + &H0) + &H0) + PartyAdý))
End Select
End Function
Function GetPlayerBase(ByVal TargetChar As Long)
        ...
        Mob = TargetChar: Ptr = ReadLong(KO_FLDB): tmpCharBase = ReadLong(Ptr + &H3C): tmpBase = ReadLong(tmpCharBase + &H4)
        While tmpBase <> 0
            IDArray = ReadLong(tmpBase + &HC)
            If IDArray >= Mob Then
                If IDArray = Mob Then BaseAddr = ReadLong(tmpBase + &H1E4) 'BASE
                tmpBase = ReadLong(tmpBase + &H0)
            Else: tmpBase = ReadLong(tmpBase + &H8)
            End If
        Wend
