...
If a.LocationURL = Label8.Caption & "key_on.php" Then MsgBox "Yükleme Baþarýlý" & vbCrLf & "Toplam Gün : " & a.Document.getelementbyid("kgun").value, vbOKOnly, "Reg."
If a.LocationURL = Label8.Caption & "key_off.php" Then MsgBox "Key Geçersiz", vbOKOnly, "Reg.": Command5.Enabled = True
If a.LocationURL = Label8.Caption & "uye_var.php" Then MsgBox "Kullanýcý adý veya e-mail kullanýlýyor.", vbOKOnly, "Reg."
If a.LocationURL = Label8.Caption & "uye_ok.php" Then MsgBox "Yeni kayýt baþarýlý.", vbOKOnly, "Reg.": Command4.Enabled = False
If a.LocationURL = Label8.Caption & "uye_off.php" Then MsgBox "Yeni kayýt baþarýsýz.", vbOKOnly, "Reg."
If a.LocationURL = Label8.Caption & "uye_yok.php" Then MsgBox "Üye bulunamadý.", vbOKOnly, "Reg."
If a.LocationURL = Label8.Caption & "uye_paneli.php" Then
If a.Document.getelementbyid("kgun").value > 0 Then
MsgBox "Giriþ Baþarýlý." & vbCrLf & "Kalan Gün : " & a.Document.getelementbyid("kgun").value, vbOKOnly, "Reg."
Form1.Show
Unload Me
Else
MsgBox "Giriþ Baþarýsýz Yükleme Yapýnýz." & vbCrLf & "Kalan Gün : " & a.Document.getelementbyid("kgun").value, vbOKOnly, "Reg."
End If
End If
End Sub
