...
Begin VB.Form Form1 
   ...
   Begin XtremeSuiteControls.GroupBox GroupBox2 
      ...
      Begin XtremeSuiteControls.TabControl TabControl2 
         ...
         Item(0).Control(33)=   "Line5"
         Item(0).Control(34)=   "L(10)"
         Item(0).Control(35)=   "Label9"
         Item(0).Control(36)=   "ProgressBar2"
         ...
         Item(6).ControlCount=   12
         Item(6).Control(0)=   "lwMob"
         Item(6).Control(1)=   "lstMap"
         ...
         Begin XtremeSuiteControls.GroupBox GroupBox3 
            ...
            Begin XtremeSuiteControls.CheckBox CheckBox9 
               ...
               _ExtentY        =   450
               _StockProps     =   79
               Caption         =   "Wait `till monster die (Z)"
...
Private Sub outsideboxes_DragDrop(Source As Control, X As Single, Y As Single)
